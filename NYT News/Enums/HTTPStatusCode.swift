...
/// The first digit of the status code specifies one of five classes of response; an HTTP client must
/// recognise these five classes at a minimum.
enum HTTPStatusCode: Int, Error {

    /// The response class representation of status codes, these get grouped by their first digit.
    enum ResponseType {

        /// - informational: This class of status code indicates a provisional response, consisting only of
        ...
        /// - redirection: This class of status code indicates the client must take additional action to
    ...
    /// - nonAuthoritativeInformation: The server is a transforming proxy (e.g. a Web accelerator) that received a
    ...
    /// - partialContent: The server is delivering only part of the resource (byte serving) due to a
    ...
    /// - useProxy: The requested resource is available only through a proxy, the address for which is
    ...
    /// - notAcceptable: The requested resource is capable of generating only content not
    ...
    /// - conflict: Indicates that the request could not be processed because of conflict in the
    ...
    /// - lengthRequired: The request did not specify the length of its content, which is required by
    ...
    /// - rangeNotSatisfiable: The client has asked for a portion of the file (byte serving), but
...
case unprocessableEntity = 422
    ...
    /// - upgradeRequired: The client should switch to a different protocol such as TLS/1.0, given in
    ...
    /// - noResponse: Used to indicate that the server has returned no information to the client and
    /// closed the connection.
    case noResponse = 444

    /// - unavailableForLegalReasons: A server operator has received a legal demand to deny access to
    /// a resource or to a set of resources that includes the requested resource.
    case unavailableForLegalReasons = 451

    /// - SSLCertificateError: An expansion of the 400 Bad Request response code, used when the client has
    /// provided an invalid client certificate.
    case SSLCertificateError = 495

    /// - SSLCertificateRequired: An expansion of the 400 Bad Request response code, used when
    /// a client certificate is required but not provided.
    case SSLCertificateRequired = 496

    /// - HTTPRequestSentToHTTPSPort: An expansion of the 400 Bad Request response code, used when
    ...
    /// - internalServerError: A generic error message, given when an unexpected condition was encountered and
    ...
    /// - badGateway: The server was acting as a gateway or proxy and received an invalid response from
    ///  the upstream server.
    case badGateway = 502
    ...
    /// - gatewayTimeout: The server was acting as a gateway or proxy and did not receive a timely response from
    ///  the upstream server.
